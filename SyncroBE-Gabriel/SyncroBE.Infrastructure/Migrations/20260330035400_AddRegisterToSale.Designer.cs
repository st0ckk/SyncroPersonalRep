...
namespace SyncroBE.Infrastructure.Migrations
{
    ...
    [Migration("20260330035400_AddRegisterToSale")]
    partial class AddRegisterToSale
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SyncroBE.Domain.Entities.ClientAccount", b =>
                {
                    ...
                    b.Property<string>("ClientAccountConditions")
                        .IsRequired()
                        .HasColumnType("varchar(max)")
            ...
            modelBuilder.Entity("SyncroBE.Domain.Entities.ClientAccountMovement", b =>
                {
                    ...
                    b.Property<decimal>("ClientAccountMovementOldBalance")
                        .HasColumnType("decimal(18, 2)")
            ...
            modelBuilder.Entity("SyncroBE.Domain.Entities.Invoice", b =>
                {
                    b.HasOne("SyncroBE.Domain.Entities.Purchase", "Purchase")
                        .WithOne("Invoice")
                        .HasForeignKey("SyncroBE.Domain.Entities.Invoice", "PurchaseId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
